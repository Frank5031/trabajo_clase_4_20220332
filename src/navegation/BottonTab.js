...
import ApiPersonal from '../screens/ApiPersonal';
    ...
    <Tab.Navigator>
      ...
      <Tab.Screen
        ...
        options={{
          ...
          headerTintColor: '#fff',
          tabBarIcon: ({ color }) => (
            <Ionicons name="QQ" color={color} size={24} />
          ),
        }}
      />
      <Tab.Screen
        name="ApiPersonal"
        component={ApiPersonal}
        options={{
          title: 'Generador de gatitos',
          tabBarActiveTintColor: '#3b4cca',
          headerStyle: {
            backgroundColor: '#3b4cca',
          },
          headerTintColor: '#fff',
          tabBarIcon: ({ color }) => (
            <Ionicons name="paw" color={color} size={24} /> // Icono actualizado
          ),
        }}
      />
    </Tab.Navigator>
